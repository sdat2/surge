     ...
     I introduce simple algorithms for selecting coastlines,
      with two new metrics for the bathymetry and convexity of the coast.
       I define two new metrics for the responsiveness of a coast point to the sea stress state.
        The bathymetry and convexity fail to be robustly predictive of the responsiveness of coastlines
        ...
        to show that the there is a reasonable method for combining physical
        and statistical knowledge to better estimate hazards. This should provide
