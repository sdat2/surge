...
\paragraph{Introduction to azimuthally symmetric models}
...
\paragraph{Holland Hurricane Model}
...
This can be modified to a more general relation
where $Ur^{x}=\text{constant}$
where X is a new parameter to fit,
which lies between 0.4 and 0.6~\cite{holland1980analytic}.

\input{cutouts/unneeded-hurricane.tex}
